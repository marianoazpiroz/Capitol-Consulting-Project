...
class PriceServiceTest {
	...
	void test1() {
		...
		priceRequest = new PriceRequest(LocalDate.parse("2020-06-14T10:00:00"), 35455L, 1L);
	...
	void test2() {
		...
		priceRequest = new PriceRequest(LocalDate.parse("2020-06-14T16:00:00"), 35455L, 1L);
	...
	void test4() {
		...
		priceRequest = new PriceRequest(LocalDate.parse("2020-06-15T10:00:00"), 35455L, 1L);
	...
	void test5() {
		...
		priceRequest = new PriceRequest(LocalDate.parse("2020-06-16T21:00:00"), 35455L, 1L);
